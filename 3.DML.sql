 ...
 *  새로운 고객의 정보를 삽입하시오.
 *  그런 다음 고객 테이블의 모든 내용을 검색하여 새로 추가된 튜플을 확인하시오.
 */

INSERT INTO 고객
VALUES ('swrawberry','최유경',30,'vip','공무원',100);
COMMIT;

INSERT INTO 고객 (고객아이디,고객이름,등급)
VALUES ('swrawberry','최유경','vip');
COMMIT;
...
/*
    주문 테이블에서 정소화 고객이 주문한 제품의 주문수량을 5개로 수정하시오.
    그런 다음 주문 테이블의 모든 내용을 검색하여 수정내용 확인하시오.
*/
